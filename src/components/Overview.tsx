    ...
    return (
        <section className="py-10 px-4 sm:px-6 lg:px-8 bg-white">
            <div className="max-w-4xl mx-auto">
                ...
                <h3 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-4 text-center">Misi Disdik Jakarta</h3>
                <ul className="list-disc pl-5 text-gray-700 space-y-2 text-sm sm:text-base">
                        <li>Mewujudkan akses pendidikan yang merata dan berkeadilan.</li>
                        <li>Meningkatkan mutu pembelajaran di semua jenjang pendidikan.</li>
                        <li>Meningkatkan efektivitas birokrasi dalam pelayanan pendidikan.</li>
                        <li>Meningkatkan kualitas dan kuantitas sarana serta prasarana pendidikan.</li>
                        <li>Memperkuat peran serta ekosistem pendidikan.</li>
                        <li>Mewujudkan tata kelola, akuntabilitas, dan transparansi dalam pendidikan.</li>
                </ul>
            </div>
        </section>
    )
