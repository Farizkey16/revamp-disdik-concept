...
export default function Navbar() {
  ...
  return (
    <nav className="bg-white shadow w-full sticky top-0 z-50   ">
      <div className="flex items-center px-4 justify-between  max-w-7xl mx-auto">
        ...
        <div className="flex items-center">
          ...
          />
          <span className="text-md font-bold md:hidden lg:block">
            Halo, {state.user?.email || "tamu" + "!"}
          </span>
        </div>
          ...
          <li>
            {state.isAuthenticated === true ? (
              <Button
                ...
                className="cursor-pointer font-bold bg-red-500 hover:bg-red-700"
              >
                Keluar
              </Button>
            ) : (
