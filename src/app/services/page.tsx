...
export default function ServicesPage() {
  return (
    <main className="relative w-full h-[60vh] md:h-[80vh] pt-20">
      {/* Services Hero */}
      ...
      <div className="relative flex flex-col justify-center items-center text-left z-10 mx-auto h-full text-white px-2 md:px-0">
        ...
        <p className="px-2 sm:px-4 max-w-xl sm:max-w-2xl md:max-w-3xl text-sm sm:text-base md:text-lg text-center">
          Layanan yang tersedia secara publik di Dinas Pendidikan DKI Jakarta
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {servicesBox.map((value, index: number) => {
            ...
            return (
              ...
              >
                <div className="w-6 h-6 text-blue-600 mb-4">
                  <IconComponent />
                </div>
